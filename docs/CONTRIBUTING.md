...
2. Clone your forked repository:
   ```bash
   git clone https://github.com/kinxlo/bytealley.git
   ```
3. Navigate to the project directory:
   ```bash
   cd <repo-name> (in your case "bytealley")
   ```
...
If you find a bug, please open an issue on [GitHub Issues](https://github.com/kinxlo/bytealley/issues) and include as much detail as possible. Provide steps to reproduce, expected and actual behavior, and any relevant logs.

### Suggesting Features

If you have an idea for a new feature, please open an issue on [GitHub Issues](https://github.com/kinxlo/bytealley/issues) and describe your proposal. Explain why the feature would be useful and how it should work.
...
1. Create a new branch for your work:
   ```bash
   git checkout -b feat/bytealley-123-your-feature-name
   ```
   ##### Branch Naming Rules
...
2. Make your changes, and commit them with descriptive messages:
   ...
   > Another example: `refactor: use a single state for formData #issue-number` or `refactor(bytealley-1234): use a single state for formData`
